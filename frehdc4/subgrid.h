...
typedef struct Sub
{
  ...
  double *allCnAR, *allCn, *Cn, *allYhX, *allYhY, *YhX, *YhY;
  double *allvar, *allvarAR, *allVo, *allZo, *allNmin, *allOmin, *Nmin, *Omin, *allNmax, *allOmax, *Nmax, *Omax;
  double *allphiX, *allphiY, *phiX, *phiY, *allZ0, *Z0;
  double *allminVxp, *allminVyp, *allminVxm, *allminVym, *minVxp, *minVxm, *minVyp, *minVym, *minVx, *minVy;
}Sub;
