...
typedef struct Config
{
  ...
  int inflowN, inflowLoc[1000], windspdN, winddirN, evapN, rainN, inflow_rank;
  ...
  double surfmax, surfmin, dsurf, divider, beta, Cv, b;
  // use staggered subgrid volume or not
  int staggeredV, useminV;
  // use min face area
  int useminA, phiSurface, advChannel, minNind[20], minOind[20], NindN, OindN, recircZone;
  // -------------------- MPI settings -----------------------------------------
  int useMPI, np;
